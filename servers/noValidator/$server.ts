...
export default (router: Router, options: FrourioOptions = {}) => {
  ...
  /* prettier-ignore */ router.get(bp || '/', m2h(c0.get, [h0, ch0], {}, [], [['id', 's', false, false], ['disable', 's', false, false]], true, ce, nrw))
  /* prettier-ignore */ router.post(bp || '/', m2h(c0.post, [h0, ch0], {}, [], [['id', 's', false, false], ['disable', 's', false, false]], false, ce, nrw))
  /* prettier-ignore */ router.get(`${bp}/empty/noEmpty`, m2h(c1.get, [h0], {}, [], [], false, ce, nrw))
  /* prettier-ignore */ router.post(`${bp}/multiForm`, m2h(c2.post, [h0], {}, [], [], false, ce, nrw))
  /* prettier-ignore */ router.get(`${bp}/texts`, m2h(c3.get, [h0], {}, [], [['val', 's', false, false]], false, ce, nrw))
  /* prettier-ignore */ router.put(`${bp}/texts`, m2h(c3.put, [h0], {}, [], [], false, ce, nrw))
  /* prettier-ignore */ router.put(`${bp}/texts/sample`, m2h(c4.put, [h0], {}, [], [], false, ce, nrw))
  /* prettier-ignore */ router.get(`${bp}/users`, m2h(c5.get, [h0, h1, ch5], {}, [], [], false, ce, nrw))
  /* prettier-ignore */ router.post(`${bp}/users`, m2h(c5.post, [h0, h1, ch5], {}, [], [], false, ce, nrw))
  /* prettier-ignore */ router.get(`${bp}/users/:userId`, m2h(c6.get, [h0, h1], {}, ['userId'], [], false, ce, nrw))
