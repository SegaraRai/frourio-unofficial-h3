...
export default (router: Router, options: FrourioOptions = {}) => {
  ...
  /* prettier-ignore */ router.post(`${basePath}/multiForm`, methodToHandler(controller2.post, [hooks0], { body: zMultiForm }, [], [], false, createError))
  ...
  /* prettier-ignore */ router.post(`${basePath}/users`, methodToHandler(controller5.post, [hooks0, hooks1, ctrlHooks5], { body: zUserInfo }, [], [], false, createError))
